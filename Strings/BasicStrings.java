...
public class BasicStrings {
    ...
    public static void main(String[] args) {
        ...
        // String name = sc.next();
        // System.out.println(name);// only prints Arun not Arun kumar bcoz space or
        // next line characters wont read
        ...
        // imp: length of string is not the same as length of char array, it is the
        // number of characters in the string + 1 which is the null character
        ...
        System.out.println(name2.charAt(name2.length()-1)); // prints null character
        // if name2 is Arun
    }
